...
import {messagesSPA} from '../../helpers/calendar-lang-es';
import BasicModal from '../../components/Modal/BasicModal';
import AgregarTurnoMedicoForm from '../../components/Turno/AgregarTurnoMedicoForm';
...
import './AppointmentsSchedule.scss';
...
export default function AppointmentsSchedule() {
    ...
    const handlerModal=(event)=>{
        ...
        setContentModal(<AgregarTurnoMedicoForm reserved={reserved} setReserved={setReserved} setShowModal={setShowModal} setReloading={setReloading}/>);
        setShowModal(true);
    }
